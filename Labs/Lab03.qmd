...
Picking a random penguin, do we expect it to be close to this center? In other words, will any one random penguin have a bill length near to 44mm or could it be spread equally between 30mm and 50mm? This notion of _spread_ or _variability_ is quantified in the **deviations**. The average deviation is the _average difference_ from the group average. Usually we'll use the _standard_ deviation, specifically.
